...
public interface ProductDao extends CommonDao<Product>{
	...
	List<Pair<Enum<?>, String>> FieldTypes = Arrays.asList(
		...
		new Pair<Enum<?>, String>(Field.NET_COST, "DECIMAL"),
		new Pair<Enum<?>, String>(Field.MARKET_PRICE, "DECIMAL"),
		new Pair<Enum<?>, String>(Field.PRICE_VISIBLE_ROLE_ID, "INTEGER"),
